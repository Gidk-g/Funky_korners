...
class StageEditorState extends MusicBeatState
{
    ...
    function addCharactersUI() {
        ...
        gfSelect = new FlxUIDropDownMenuCustom(140, 90, FlxUIDropDownMenuCustom.makeStrIdLabelArray([''], true), function(sprite:String)
            {
                //dad.x = 0;
                //dad.y = 0;
        ...
        charDropDown = new FlxUIDropDownMenuCustom(gfSelect.x-130, gfSelect.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray([''], true), function(character:String)
		{
