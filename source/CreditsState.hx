...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		add(bg);
		bg.setGraphicSize(Std.int(bg.width * 0.750));
		bg.screenCenter();
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs Korner\'s Funky Club Team'],
			['Kolze','kolze','Owner, Main Programmer, Main Composer and Main Charter (wow this guy works a LOT)','https://www.youtube.com/channel/UC4kCEHIdvCRb8nApaaUtsxA','00F3FF'],
			...
			['Anvitar','anvitar','Additional Artist','https://www.youtube.com/channel/UCBiLf4y2xi7UBOxNr1zEpXg','D7875B'],
			...
			[''],
			['Former Mod Members'],
			['Kaczak',			'kaczak',				'Ex-Owner',								'https://www.youtube.com/channel/UC4uSjw8Cd7Gu6j8uSYQ8WBQ', 'FFF444'],
			['Anaxii',			'anaxii',				'Ex-Additional Artist',								'https://www.youtube.com/channel/UC4uSjw8Cd7Gu6j8uSYQ8WBQ',			'F2BDF4'],
			[''],
			['Korner Engine Team'],
			['Gidk',			'gidk',		'Main Programmer',						'https://www.youtube.com/channel/UCZu360PL3Nr-ppBmmmZhS2w',		'FFFFFF'],
			['Kolze',				'kolze',			'Additional Programmer',					'https://www.youtube.com/channel/UC4kCEHIdvCRb8nApaaUtsxA',			'00F3FF'],
			[''],
			['Psych Engine Team'],
